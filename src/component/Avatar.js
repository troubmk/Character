...
function Avatar({ body, hair, mouths, eyes, eyebrows, earrings,hats,glasses,neckwear, clothing1,clothing2,clothing3 }) {
     return (
        <div className="avatar">
            ...
            <img src={`/character/noses/1.png`} alt="" width={260} style={{zIndex:2,position:`absolute`}}/>
            <img src={`/character/mouths/${mouths}.png`}  alt="" width={260} style={{zIndex:2,position:`absolute`}}/>
            <img src={`/character/eyes/${eyes}.png`} alt="" width={260} style={{zIndex:2,position:`absolute`}}/>
            <img src={`/character/eyebrows/${eyebrows}.png`} alt="" width={260} style={{zIndex:2,position:`absolute`}}/>
            ...
            <img src={`/character/accessories/glasses/${glasses}.png`} alt="" width={260} style={{zIndex:3,position:`absolute`}}/>
            <img src={`/character/accessories/neckwear/${neckwear}.png`} alt="" width={260} style={{zIndex:3,position:`absolute`}}/>
